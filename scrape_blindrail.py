...
BASE_URL = "https://droprail.dev/"
OUTPUT_DIR = "."

def download_file(url, local_path):
    # Clean query strings from local path (e.g. icon.svg?123 -> icon.svg)
...
def scrape_site():
    ...
    # 2. Deep scan Next.js CSS and JS chunks for extra assets (images/fonts/chunks)
    asset_regex = re.compile(r'(/_next/[a-zA-Z0-9_/-]+\.[a-zA-Z0-9]+)')
